...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.fileButton.setGeometry(QtCore.QRect(500, 520, 101, 35))
        self.fileButton.setObjectName("fileButton")
        self.phoneButton = QtWidgets.QPushButton(Form)
        self.phoneButton.setGeometry(QtCore.QRect(340, 520, 101, 35))
        self.phoneButton.setObjectName("phoneButton")
        self.phoneLabel = QtWidgets.QLabel(Form)
        self.phoneLabel.setGeometry(QtCore.QRect(305, 520, 31, 31))
