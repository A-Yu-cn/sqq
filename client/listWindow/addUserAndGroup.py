...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.startGroupButton.setGeometry(QtCore.QRect(15, 84, 123, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.startGroupButton.setFont(font)
        self.startGroupButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.startGroupButton.setObjectName("startGroupButton")
        self.searchButton = QtWidgets.QPushButton(Form)
        self.searchButton.setGeometry(QtCore.QRect(155, 84, 123, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
